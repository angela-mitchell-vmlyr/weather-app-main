        ...
        <div className="daily-forecast">
          ...
          <div className="daily-forecast__grid">
            {Array.from({ length: 7 }).map((_, i) => (
              <Skeleton key={i} height="8rem" borderRadius="var(--radius-24)" />
            ))}
          </div>
        </div>
      </div>
      ...
      <div className="weather-grid__sidebar">
        <div className="hourly-forecast">
          <div className="hourly-forecast__header">
            ...
            <Skeleton width="3rem" height="1.5rem" borderRadius="var(--radius-16)" />
          </div>
          <div className="hourly-forecast__list">
            {Array.from({ length: 8 }).map((_, i) => (
              <div key={i} style={{ padding: 'var(--spacing-16) 0' }}>
